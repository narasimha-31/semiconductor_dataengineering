...
INSERT_SQL = """
    INSERT INTO bronze.regulatory_raw
        (document_number, title, doc_type, abstract, publication_date,
         html_url, agencies, kafka_partition, kafka_offset, batch_id)
    VALUES %s
    ON CONFLICT ON CONSTRAINT uq_regulatory_raw DO NOTHING
"""
...
def run_consumer(bootstrap_servers='localhost:9092', db_config=None,
    ...
    consumer = Consumer({
        ...
        'group.id': 'bronze-regulatory-writer',
